...
const Form = ({ title, inputs, extra , button , confirm}) => {
    ...
    return (
        <section className='z-1 w-[16em] h-[20em] '>
                ...
                <div className="size-full flex justify-center items-center p-6">
                    <div className="flex flex-col size-full ">
                        ...
                        <div className='flex flex-col w-full h-full p-4 justify-center items-center '>
                            <button onClick={() => confirm(info)} className='m-2 w-full h-[2em] bg-primary text-white text-lg hover:bg-blue-500 transition-colors'>{button}</button>
