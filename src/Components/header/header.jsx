        ...
        <main className='className="flex w-full h-full bg-[#e6e6e6]'>
            <nav className='flex bg-[#1b2130] h-8 w-full flex-col static'>
                <div className='flex w-full h-full items-center flex-row'>
                    <section className=' flex flex-row pl-[2%] gap-[4%] w-full'>
                        <a className='no-underline! text-white cursor-pointer'>About</a>
                        <a className='no-underline! text-white cursor-pointer'>School</a>
                        <a className='no-underline! text-white cursor-pointer'>Algumaoutracoisaai</a>
                    </section>
                    <section className='flex flex-row-reverse pr-[2%] gap-[3%] w-1/2 static fill-white!'>
                        <svg className='fill-white cursor-pointer hover:fill-[#b862ff]! transition-all duration-350 ease-in-out' xmlns="http://www.w3.org/2000/svg" width="16" height="16"  class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <svg className='fill-white cursor-pointer hover:fill-[#8afc8e]! transition-all duration-350 ease-in-out' xmlns="http://www.w3.org/2000/svg" width="16" height="16"  class="bi bi-whatsapp" viewBox="0 0 16 16">
            ...
            <nav className='w-full flex h-14 bg-white shadow-[0px_3px_2px_rgba(128,128,128,1)] justify-center '>
                <section className='flex flex-row w-[60%] justify-center '>
                    ...
                    <div className='flex items-center w-[20%] border-b-4 border-r border-r-gray-400 border-b-green-600'><a className='flex w-full justify-center items-center text-center no-underline! text-black'>Academia</a></div>
                    <div className='flex items-center w-[20%] border-b-4 border-r border-r-gray-400 border-b-blue-400'><a className='flex w-full justify-center items-center text-center no-underline! text-black'>Projetos</a></div>
